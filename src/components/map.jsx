...
const MapUniversity = () =>{
  ...
  useEffect(()=>{
    axios.get("https://api.mapbox.com/geocoding/v5/mapbox.places/"+address+".json?access_token=pk.eyJ1IjoiYWRpdHlhdGhha2FyIiwiYSI6ImNrd2thZzBzbDFxaHQycW5zdTFjNWpra3YifQ.ceU-3_9E_vJ2xv4gQTSm8A",).then(res=>{
  ...
  return (
    <div className="map-container">
      <MapGL
        mapStyle={"mapbox://styles/adityathakar/ckwkw9jjza7i114mp87e0pbju"}
        ref={mapRef}
        {...viewport}
        width="100%"
        height="100%"
      ...
      >
        ...
        <Marker latitude={lat} longitude={long} offsetTop={-48}
            offsetLeft={-24}><img src="https://img.icons8.com/color/48/000000/marker.png"></img></Marker>
