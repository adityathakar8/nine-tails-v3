...
function UniPage(){
  ...
  useEffect(()=>{
    ...
    axios.get("https://api.unsplash.com/search/photos?query="+college+"&client_id=IVpa8topojL7EFSbV96j06RRI0UgqPDuHZiBwAsXxAQ").then(res=>{
  ...
  return (
    ...
    <div className="row">
    <div className="col">
    <h3 className="uni-page-elements uni-page-titles" >Cost  </h3>
    <h3 className="uni-page-elements  uni-page-data" > {data.cost}</h3>
    </div>
    <div className="col">

    <h2 className="uni-page-elements uni-page-titles">Average Living Expenses</h2>
    <h4  className="uni-page-elements  uni-page-data">{data.avg_living}</h4>
    </div>
    </div>
    ...
    <h3 className="uni-page-elements  uni-page-data" >{data.qsRank}</h3>
    <img className="uni-page-elements uni-page-img" src={data.qsLogo}></img>
    </div>
    <div className="col col-img">

    <h3 className="uni-page-elements  uni-page-data" >{data.wur}</h3>
    <img className="uni-page-elements uni-page-img" src={data.wurLogo}></img>
    </div>
    </div>
    </div>
    <a href={url} className="uni-page-elements btn btn-danger btn-lg"><i class="fas fa-home"></i></a>
